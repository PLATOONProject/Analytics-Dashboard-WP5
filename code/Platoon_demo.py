...
if __name__ == '__main__':
    ...
    folder = Path(Path(__file__).parent.parent.parent, NAME_DEMO)
    variables = ['2m_temperature', 'snowfall',
                 'clear_sky_direct_solar_radiation_at_surface']
    pklpath_cds = folder / 'meteo_cds.pkl'
    ...
    output_file(folder / f"{NAME_DEMO}_TimeLines_cds.html")
    ...
    output_file(folder / f"{NAME_DEMO}_Scatter_cds.html")
    show(p)
